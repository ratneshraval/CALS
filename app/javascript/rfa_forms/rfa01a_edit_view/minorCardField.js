    ...
    return (
      <form>
        <DropDownField gridClassName='col-md-4' id='relationship_to_applicant'
          ...
          value={minor.relationship_to_applicant}
        ...
        <DropDownField gridClassName='col-md-4' id='gender' label='Gender'
          value={minor.gender}
          selectClassName='reusable-select'
        ...
        <DropDownField id='child_financially_supported' gridClassName='col-md-4'
        ...
        <DropDownField id='child_adopted' gridClassName='col-md-4'
